...
GVAR(IDF_MODERATOR, vetolock, 0, PRIV_OPERATOR, PRIV_MAX);
GVAR(IDF_MODERATOR, editlock, 0, PRIV_OPERATOR, PRIV_MAX);
...
GVAR(IDF_GAMEMOD, overtimelimit, 0, 3, VAR_MAX); // maximum time overtime may last, 0 = forever
...
GVAR(IDF_GAMEMOD, teambalancewait, 0, 30000, VAR_MAX); // how long before can happen again
GVAR(IDF_GAMEMOD, teambalancedelay, 0, 5000, VAR_MAX); // how long before reassignments start
...
GVAR(IDF_GAMEMOD, teambalancestyle, 0, 4, 4); // when moving players, sort by: 0 = top of list, 1 = lowest time played, 2 = lowest points, 3 = lowest frags, 4 = lowest skill
...
GVAR(IDF_GAMEMOD, impulsekickdelay, 0, 350, VAR_MAX); // minimum time between wall kicks/climbs
GFVAR(IDF_GAMEMOD, impulsevaultmin, FVAR_NONZERO, 0.25f, FVAR_MAX); // minimum percentage of height for vault
GFVAR(IDF_GAMEMOD, impulsevaultmax, FVAR_NONZERO, 1.f, FVAR_MAX); // maximum percentage of height for vault
...
GFVAR(IDF_GAMEMOD, deadstunscale, 0, 2, FVAR_MAX);
...
GFVAR(IDF_GAMEMOD, gladiatorpushscale, 0, 10, FVAR_MAX);
GFVAR(IDF_GAMEMOD, gladiatorhitpushscale, 0, 10, FVAR_MAX);
GFVAR(IDF_GAMEMOD, gladiatordeadpushscale, 0, 20, FVAR_MAX);
GFVAR(IDF_GAMEMOD, gladiatorwavepushscale, 0, 10, FVAR_MAX);

GFVAR(IDF_GAMEMOD, gladiatorstunscale, 0, 10, FVAR_MAX);
GFVAR(IDF_GAMEMOD, gladiatorhitstunscale, 0, 10, FVAR_MAX);
GFVAR(IDF_GAMEMOD, gladiatordeadstunscale, 0, 20, FVAR_MAX);
GFVAR(IDF_GAMEMOD, gladiatorwavestunscale, 0, 10, FVAR_MAX);

GFVAR(IDF_GAMEMOD, gladiatorvelscale, 0, 10, FVAR_MAX);
GFVAR(IDF_GAMEMOD, gladiatorhitvelscale, 0, 10, FVAR_MAX);
GFVAR(IDF_GAMEMOD, gladiatordeadvelscale, 0, 20, FVAR_MAX);
GFVAR(IDF_GAMEMOD, gladiatorwavevelscale, 0, 10, FVAR_MAX);
...
GFVAR(IDF_GAMEMOD, gladiatorextradeadvelscale, 0, 1, FVAR_MAX);
