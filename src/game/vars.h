...
GFVAR(IDF_GAMEMOD, gravitycrouch, 0, 1.125f, FVAR_MAX);
GFVAR(IDF_GAMEMOD, gravityjump, 0, 0.85f, FVAR_MAX);
GFVAR(IDF_GAMEMOD, gravityjumpcrouch, 0, 1, FVAR_MAX);
...
GVAR(IDF_GAMEMOD, regendelay, 0, 5000, VAR_MAX); // regen after no damage for this long
GVAR(IDF_GAMEMOD, regentime, 0, 2000, VAR_MAX); // regen this often when regenerating normally
GVAR(IDF_GAMEMOD, regenhealth, 0, 100, VAR_MAX); // regen this amount each regen
GVAR(IDF_GAMEMOD, regendecay, 0, 50, VAR_MAX); // if over maxhealth, decay this amount each regen
...
GFVAR(IDF_GAMEMOD, capturecarryjumpspeed, FVAR_MIN, 0, FVAR_MAX);
GFVAR(IDF_GAMEMOD, capturecarryjumpspeedeach, FVAR_MIN, -5, FVAR_MAX);
GFVAR(IDF_GAMEMOD, capturecarryimpulsespeed, FVAR_MIN, 0, FVAR_MAX);
GFVAR(IDF_GAMEMOD, capturecarryimpulsespeedeach, FVAR_MIN, -5, FVAR_MAX);
GFVAR(IDF_GAMEMOD, capturecarryspeed, FVAR_MIN, 0, FVAR_MAX);
GFVAR(IDF_GAMEMOD, capturecarryspeedeach, FVAR_MIN, -5, FVAR_MAX);
GFVAR(IDF_GAMEMOD, capturecarryweight, FVAR_MIN, 5, FVAR_MAX);
GFVAR(IDF_GAMEMOD, capturecarryweighteach, FVAR_MIN, 5, FVAR_MAX);
...
GFVAR(IDF_GAMEMOD, bombercarryjumpspeed, FVAR_MIN, -5, FVAR_MAX);
GFVAR(IDF_GAMEMOD, bombercarryimpulsespeed, FVAR_MIN, -5, FVAR_MAX);
GFVAR(IDF_GAMEMOD, bombercarryspeed, FVAR_MIN, -5, FVAR_MAX);
GFVAR(IDF_GAMEMOD, bombercarryweight, FVAR_MIN, 10, FVAR_MAX);
...
GFVAR(IDF_GAMEMOD, impulselaunch, 0, 0.9f, FVAR_MAX); // launch modifier
GFVAR(IDF_GAMEMOD, impulselaunchredir, 0, 1, FVAR_MAX); // how much of the old velocity is redirected into the new one
GFVAR(IDF_GAMEMOD, impulselaunchpitchmin, -89.9f, 15.f, 89.9f); // launch pitch minimum
...
GFVAR(IDF_GAMEMOD, impulseclimb, 0, 1, FVAR_MAX); // parkour climb modifier
GFVAR(IDF_GAMEMOD, impulseclimbredir, 0, 1, FVAR_MAX); // how much of the old velocity is redirected into the new one
GFVAR(IDF_GAMEMOD, impulseclimbendmin, 0, 5, 89.9f); // parkour climb end minimum pitch
GFVAR(IDF_GAMEMOD, impulseclimbvaultmin, FVAR_NONZERO, 0.25f, FVAR_MAX); // minimum percentage of height for vault
GFVAR(IDF_GAMEMOD, impulseclimbvaultmax, FVAR_NONZERO, 1.6f, FVAR_MAX); // maximum percentage of height for vault
...
GFVAR(IDF_GAMEMOD, impulsegrabplayer, 0, 2, FVAR_MAX); // parkour grab player modifier
...
GVAR(IDF_GAMEMOD, impulseslidelen, 0, 1000, VAR_MAX); // time before slides end
GVAR(IDF_GAMEMOD, impulseparkourlen, 0, 1250, VAR_MAX); // length of time a run along a wall can last

GVAR(IDF_GAMEMOD, impulsejumpdelay, 0, 250, VAR_MAX); // minimum time after jump for boost
GVAR(IDF_GAMEMOD, impulseboostdelay, 0, 500, VAR_MAX); // minimum time between boosts
GVAR(IDF_GAMEMOD, impulseslidedelay, 0, 1000, VAR_MAX); // minimum time between slides
GVAR(IDF_GAMEMOD, impulseslideinair, 0, 100, VAR_MAX); // minimum time in air for slide
GVAR(IDF_GAMEMOD, impulseparkourdelay, 0, 500, VAR_MAX); // minimum time between parkour moves
...
GFVAR(IDF_GAMEMOD, impulsecostkick, 0, 1, FVAR_MAX); // scale cost kick move
...
GVAR(IDF_GAMEMOD, impulsecostscale, 0, 0, 1); // whether the cost scales depending on the amount the impulse scales
