...
enum { SPHY_NONE = 0, SPHY_JUMP, SPHY_BOOST, SPHY_SLIDE, SPHY_MELEE, SPHY_KICK, SPHY_GRAB, SPHY_PARKOUR, SPHY_AFTER, SPHY_COOK, SPHY_MATERIAL, SPHY_EXTINGUISH, SPHY_BUFF, SPHY_MAX, SPHY_SERVER = SPHY_EXTINGUISH };

#define CROUCHSTILL 0.7f
#define CROUCHMOVING 0.85f
#define GUARDRADIUS 2.f
