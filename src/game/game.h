...
enum { PULSE_FIRE = 0, PULSE_BURN, PULSE_DISCO, PULSE_SHOCK, PULSE_BLEED, PULSE_BUFF, PULSE_WARN, PULSE_REGEN, PULSE_MAX, PULSE_LAST = PULSE_MAX-1 };
...
extern const int pulsecols[PULSE_MAX][PULSECOLOURS] = {
    ...
    { 0xFF0000, 0xFF2222, 0xFF0022, 0xFF2200, 0x880000, 0x882222, 0x880022, 0x882200 }, // red bleed
    { 0xFFFFFF, 0x404000, 0x808000, 0xFFFF00, 0xFFFF20, 0xFFFF40, 0xFFFF80, 0xFFFFA0 }, // yellow shield/buff
    { 0xFF0000, 0xFF2222, 0xFF4444, 0xFF8888, 0xFFAAAA, 0xFF8888, 0xFF4444, 0xFF2222 }, // warning
...
struct inanimate : dynent
{
    ...
    inanimate() : control(INANIMATE_NONE), ent(-1), coltype(0), yawed(0), pitched(0), moved(0, 0, 0), resized(0, 0, 0), coltarget(NULL)
    {
        physent::reset();
        type = ENT_INANIMATE;
        state = CS_ALIVE;
