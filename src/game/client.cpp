            ...
            switch(type)
            {
                ...
                case N_SPHY: // simple phys events
                {
                    ...
                    switch(st)
                    {
                        ...
                        case SPHY_BOOST: case SPHY_DASH: case SPHY_POUND: case SPHY_SLIDE: case SPHY_LAUNCH: case SPHY_MELEE: case SPHY_KICK: case SPHY_GRAB: case SPHY_PARKOUR: case SPHY_AFTER:
                        {
                            if(!proceed) break;
