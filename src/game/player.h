...
enum {
    A_A_MOVE = 0, A_A_JUMP, A_A_CROUCH, A_A_DASH, A_A_BOOST, A_A_PARKOUR, A_A_MELEE, A_A_PRIMARY, A_A_SECONDARY, A_A_PLAYERS, A_A_BOTS, A_A_ENEMIES, A_A_TEAMDAMAGE, A_A_MAX,
    ...
    A_A_ALL = (1<<A_A_MOVE)|(1<<A_A_JUMP)|(1<<A_A_CROUCH)|(1<<A_A_DASH)|(1<<A_A_BOOST)|(1<<A_A_PARKOUR)|(1<<A_A_MELEE)|(1<<A_A_PRIMARY)|(1<<A_A_SECONDARY)|(1<<A_A_PLAYERS)|(1<<A_A_BOTS)|(1<<A_A_ENEMIES)|(1<<A_A_TEAMDAMAGE),
...
APVAR(IDF_GAMEMOD,  abilities, 0, A_A_ALL,
    A_A_ALL,        A_A_MOVINGAI,   A_A_FIXEDAI,    A_A_MOVINGAI,   A_A_MOVINGAI
);
