...
enum
{
    ...
    A_A_ALL = AA(MOVE)|AA(JUMP)|AA(CROUCH)|AA(MELEE)|AA(PRIMARY)|AA(SECONDARY)|AA(PUSHABLE)|AA(AFFINITY)|AA(REGEN)|AA(GIBS),
    A_A_PLAYER = AA(MOVE)|AA(JUMP)|AA(CROUCH)|AA(MELEE)|AA(PRIMARY)|AA(SECONDARY)|AA(PUSHABLE)|AA(AFFINITY)|AA(REGEN)|AA(GIBS),
    A_A_MOVINGAI = AA(MOVE)|AA(JUMP)|AA(CROUCH)|AA(MELEE)|AA(PRIMARY)|AA(SECONDARY)|AA(PUSHABLE)|AA(AFFINITY)|AA(REGEN)|AA(GIBS),
    A_A_LESSAI = AA(MOVE)|AA(JUMP)|AA(MELEE)|AA(PRIMARY)|AA(SECONDARY)|AA(PUSHABLE)|AA(GIBS),
    A_A_FIXEDAI = AA(PRIMARY)|AA(SECONDARY),
    A_A_ROLLER = AA(MOVE)|AA(JUMP)|AA(PUSHABLE)|AA(KAMIKAZE),
};
