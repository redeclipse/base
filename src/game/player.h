...
enum {
    A_A_MOVE = 0, A_A_JUMP, A_A_CROUCH, A_A_DASH, A_A_BOOST, A_A_PARKOUR, A_A_MELEE, A_A_PRIMARY, A_A_SECONDARY, A_A_COLLIDE_PLAYERS, A_A_COLLIDE_BOTS, A_A_COLLIDE_ENEMIES, A_A_TEAMDAMAGE, A_A_TEAMDAMAGE_GHOST, A_A_MAX,
    ...
    A_A_ALL = (1<<A_A_MOVE)|(1<<A_A_JUMP)|(1<<A_A_CROUCH)|(1<<A_A_DASH)|(1<<A_A_BOOST)|(1<<A_A_PARKOUR)|(1<<A_A_MELEE)|(1<<A_A_PRIMARY)|(1<<A_A_SECONDARY)|(1<<A_A_COLLIDE_PLAYERS)|(1<<A_A_COLLIDE_BOTS)|(1<<A_A_COLLIDE_ENEMIES)|(1<<A_A_TEAMDAMAGE)|(1<<A_A_TEAMDAMAGE_GHOST),
    A_A_PLAYER = (1<<A_A_MOVE)|(1<<A_A_JUMP)|(1<<A_A_CROUCH)|(1<<A_A_DASH)|(1<<A_A_BOOST)|(1<<A_A_PARKOUR)|(1<<A_A_MELEE)|(1<<A_A_PRIMARY)|(1<<A_A_SECONDARY)|(1<<A_A_COLLIDE_PLAYERS)|(1<<A_A_COLLIDE_BOTS)|(1<<A_A_COLLIDE_ENEMIES)|(1<<A_A_TEAMDAMAGE),
    A_A_MOVINGAI = (1<<A_A_MOVE)|(1<<A_A_JUMP)|(1<<A_A_CROUCH)|(1<<A_A_DASH)|(1<<A_A_BOOST)|(1<<A_A_PARKOUR)|(1<<A_A_MELEE)|(1<<A_A_PRIMARY)|(1<<A_A_SECONDARY)|(1<<A_A_COLLIDE_PLAYERS)|(1<<A_A_COLLIDE_BOTS)|(1<<A_A_COLLIDE_ENEMIES),
    A_A_LESSAI = (1<<A_A_MOVE)|(1<<A_A_JUMP)|(1<<A_A_MELEE)|(1<<A_A_PRIMARY)|(1<<A_A_SECONDARY)|(1<<A_A_COLLIDE_PLAYERS)|(1<<A_A_COLLIDE_BOTS)|(1<<A_A_COLLIDE_ENEMIES),
    A_A_FIXEDAI = (1<<A_A_PRIMARY)|(1<<A_A_SECONDARY)|(1<<A_A_COLLIDE_PLAYERS)|(1<<A_A_COLLIDE_BOTS)|(1<<A_A_COLLIDE_ENEMIES)
};
