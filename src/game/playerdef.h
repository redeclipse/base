...
#define APVAR(flags, level, name, mn, mx, player0, bot0, turret0, grunt0, drone0, roller0, hazard0) \
    ...
    PD_DECLARE(int *EXPAND(PD_PREFIX, actor_stat_##name)[], \
        ...
        &EXPAND(PD_PREFIX, hazard##name) \
    );

#define APFVAR(flags, level, name, mn, mx, player0, bot0, turret0, grunt0, drone0, roller0, hazard0) \
...
#define APSVAR(flags, level, name, player0, bot0, turret0, grunt0, drone0, roller0, hazard0) \
