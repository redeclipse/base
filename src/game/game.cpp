...
namespace game
{
    ...
    FVAR(IDF_PERSIST, mixerburnscroll, -16, 0.15f, 16);
    ...
    FVAR(IDF_PERSIST, mixerbleedscroll, -16, 0.065f, 16);
    ...
    FVAR(IDF_PERSIST, mixershockscroll, -16, 0.25f, 16);
    ...
    FVAR(IDF_PERSIST, mixerbuffscroll, -16, 0.125f, 16);
