...
#define PULSE_ENUM(en, um) \
    ...
    en(um, Dominate, DOMINATE) en(um, Revenge, REVENGE) \
    en(um, Maximum, MAX)
ENUM_DLN(PULSE)
...
extern const int pulsecols[PULSE_MAX][PULSE_COLS] = {
    { 0xCD5C5C, 0xD2691E, 0xFF8C00, 0xFFA500, 0xCD853F, 0xB22222, 0xA52A2A, 0x8B4513, 0x800000, 0x8B0000, 0x8B008B }, // flames burning
    { 0xDEB887, 0xCD853F, 0xD2B48C, 0xBC8F8F, 0xD2691E, 0x8B4513, 0xA0522D, 0xCD853F, 0xD2B48C, 0xCD853F, 0xDEB887 }, // brighter burning
    ...
    { 0xFFD700, 0xFFFFF0, 0xFFFACD, 0xFFF8DC, 0xFFEFD5, 0xFFE4B5, 0xFFDAB9, 0xFFDEAD, 0xF5DEB3, 0xFFE4C4, 0xFFEBCD }, // prize ready
    { 0x00FF00, 0xADFF2F, 0x7FFF00, 0x7CFC00, 0x32CD32, 0x00FA9A, 0x3CB371, 0x2E8B57, 0x228B22, 0x6B8E23, 0x808000 }, // prize awarded
    ...
    { 0x000000, 0x2F4F4F, 0x696969, 0x708090, 0x778899, 0x808080, 0xA9A9A9, 0xC0C0C0, 0xD3D3D3, 0xDCDCDC, 0x2F4F4F }, // revenge
};
