...
extern void part_icons(const vec &o, Texture *tex, int type, float size = 2, float blend = 1, float gravity = 0, int collide = 0, int fade = 1, int color = colourwhite, int hintcolor = 0, float hintblend = 0, float start = 0, float length = 1, physent *pl = NULL);
