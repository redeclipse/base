...
// rendergl
extern bool hasVBO, hasDRE, hasMDA, hasOQ, hasTR, hasFBO, hasDS, hasTF, hasBE, hasBC, hasCM, hasNP2, hasTC, hasS3TC, hasFXT1, hasMT, hasAF, hasGLSL, hasGM, hasNVFB, hasSGIDT, hasDT, hasPBO, hasFBB, hasUBO, hasBUE, hasMBR, hasFC;
