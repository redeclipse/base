...
//extern bool getmatcap(const vec &o, GLuint *blendtex = NULL, float *blend = NULL, int *id1 = NULL, int *id2 = NULL);
...
extern void copyhdr(int sw, int sh, GLuint fbo, int dx = 0, int dy = 0, int dw = 0, int dh = 0, bool flipx = false, bool flipy = false, bool swapxy = false);
