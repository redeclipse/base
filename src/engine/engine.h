...
extern void part_trail(int type, int fade, const vec &s, const vec &e, int color = colourwhite, float size = .8f, float blend = 1, int hintcolor = 0, float hintblend = 0, float gravity = 0, int collide = 0, float sizechange = 0);
