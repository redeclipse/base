...
extern void regular_part_create(int type, int fade, const vec &p, int color = colourwhite, float size = 4, float blend = 1, int hintcolor = 0, float hintblend = 0, float gravity = 0, int collide = 0, physent *pl = NULL, int delay = 0, float sizechange = 0);
extern void part_create(int type, int fade, const vec &p, int color = colourwhite, float size = 4, float blend = 1, int hintcolor = 0, float hintblend = 0, float gravity = 0, int collide = 0, physent *pl = NULL, float sizechange = 0);
extern void regular_part_splash(int type, int num, int fade, const vec &p, int color = colourwhite, float size = 4, float blend = 1, int hintcolor = 0, float hintblend = 0, float gravity = 0, int collide = 0, float radius = 150, float vel = 1, int delay = 0, float sizechange = 0);
extern void part_splash(int type, int num, int fade, const vec &p, int color = colourwhite, float size = 4, float blend = 1, int hintcolor = 0, float hintblend = 0, float gravity = 0, int collide = 0, float radius = 4, float vel = 1, float sizechange = 0);
extern void part_trail(int type, int fade, const vec &s, const vec &e, int color = colourwhite, float size = .8f, float blend = 1, int hintcolor = 0, float hintblend = 0, float gravity = 0, int collide = 0, float sizechange = 0, float vel = 10.0f, float stepscale = 2.0f);
extern void part_text(const vec &s, const char *t, int type = PART_TEXT, int fade = 1, int color = colourwhite, float size = 2, float blend = 1, float gravity = 0, int collide = 0, physent *pl = NULL, float sizechange = 0);
...
extern void part_flare(const vec &p, const vec &dest, int fade, int type, int color = colourwhite, float size = 2, float blend = 1, int hintcolor = 0, float hintblend = 0, float gravity = 0, int collide = 0, physent *pl = NULL, float sizechange = 0);
...
extern void part_spawn(const vec &o, const vec &v, float z, uchar type, int amt = 1, int fade = 1, int color = colourwhite, float size = 4, float blend = 1, int hintcolor = 0, float hintblend = 0, float gravity = 0, int collide = 0);
extern void part_flares(const vec &o, const vec &v, float z1, const vec &d, const vec &w, float z2, uchar type, int amt = 1, int fade = 1, int color = colourwhite, float size = 4, float blend = 1, int hintcolor = 0, float hintblend = 0, float gravity = 0, int collide = 0, physent *pl = NULL);
...
extern void part_icon(const vec &o, Texture *tex, float size = 2, float blend = 1, float gravity = 0, int collide = 0, int fade = 1, int color = colourwhite, int hintcolor = 0, float hintblend = 0, float start = 0, float length = 1, physent *pl = NULL);
...
extern void drawenvlayer(Texture *tex, float height = 0.f, const bvec &colour = bvec(255, 255 ,255), float blend = 1.f, float subdiv = 4.f, float fade = 0.f, float scale = 1.f, float offsetx = 0.f, float offsety = 0.f, float shadowblend = 0.5f, float zrot = 0.f, bool skyplane = false, bool shadowpass = false, bool cylinder = false);
