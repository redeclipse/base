...
static partrenderer *parts[] =
{
    ...
    new quadrenderer("<grey>particles/hint", PT_SOFT|PT_PART|PT_LERP|PT_BRIGHT),
    new quadrenderer("<grey>particles/hint", PT_PART|PT_LERP|PT_BRIGHT),
    new quadrenderer("<grey>particles/hint_bold", PT_SOFT|PT_PART|PT_LERP|PT_BRIGHT),
    new quadrenderer("<grey>particles/hint_bold", PT_PART|PT_LERP|PT_BRIGHT),
    new quadrenderer("<grey>particles/hint_vert", PT_SOFT|PT_PART|PT_LERP|PT_BRIGHT),
    new quadrenderer("<grey><rotate:1>particles/hint_vert", PT_PART|PT_LERP|PT_BRIGHT),
    new quadrenderer("<grey><rotate:1>particles/hint_vert", PT_SOFT|PT_PART|PT_LERP|PT_BRIGHT),
    new quadrenderer("<grey>particles/hint_vert", PT_PART|PT_LERP|PT_BRIGHT),
