...
static partrenderer *parts[] =
{
    ...
    new quadrenderer("<comp>hintbold", PT_PART|PT_BRIGHT),
    new quadrenderer("<comp>hintvert", PT_SOFT|PT_PART|PT_BRIGHT),
    new quadrenderer("<comp>hintvert", PT_PART|PT_BRIGHT),
    new quadrenderer("<comp>hinthorz", PT_SOFT|PT_PART|PT_BRIGHT),
    new quadrenderer("<comp>hinthorz", PT_PART|PT_BRIGHT),
    ...
    new quadrenderer("<comp:1>fire", PT_SOFT|PT_PART|PT_BRIGHT|PT_HFLIP|PT_RND4|PT_WIND),
    new quadrenderer("<comp:1>fire", PT_PART|PT_BRIGHT|PT_HFLIP|PT_RND4|PT_WIND),
    new quadrenderer("<comp:1>distortpartlight [tex = particles/plasma]", PT_SOFT|PT_PART|PT_BRIGHT|PT_FLIP|PT_WIND),
    ...
    new quadrenderer("<comp:1>fire", PT_PART|PT_BRIGHT|PT_HFLIP|PT_RND4|PT_BRIGHT|PT_WIND),
    ...
    new quadrenderer("<comp:1>fire", PT_HAZE|PT_PART|PT_WIND),
