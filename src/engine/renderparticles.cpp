...
static partrenderer *parts[] =
{
    ...
    new quadrenderer("!fire 1", PT_SOFT|PT_PART|PT_BRIGHT|PT_RND4|PT_WIND),
    ...
    new quadrenderer("!smoke 1", PT_SOFT|PT_PART|PT_LERP|PT_RND4|PT_WIND),
    new quadrenderer("!smoke 1", PT_PART|PT_LERP|PT_RND4|PT_WIND),
    new quadrenderer("!smoke 1", PT_SOFT|PT_PART|PT_RND4|PT_WIND),
    new quadrenderer("!smoke 1", PT_PART|PT_RND4|PT_WIND),
    ...
    new quadrenderer("!hintbold", PT_PART|PT_BRIGHT),
    new quadrenderer("!hintvert", PT_SOFT|PT_PART|PT_BRIGHT),
    new quadrenderer("!hintvert", PT_PART|PT_BRIGHT),
    new quadrenderer("!hinthorz", PT_SOFT|PT_PART|PT_BRIGHT),
    new quadrenderer("!hinthorz", PT_PART|PT_BRIGHT),
    ...
    new quadrenderer("!fire 1", PT_SOFT|PT_PART|PT_BRIGHT|PT_RND4|PT_WIND),
    new quadrenderer("!fire 1", PT_PART|PT_BRIGHT|PT_RND4|PT_WIND),
    new quadrenderer("<grey>particles/plasma", PT_SOFT|PT_PART|PT_BRIGHT|PT_FLIP|PT_WIND),
    ...
    new quadrenderer("!fire 1", PT_PART|PT_BRIGHT|PT_RND4|PT_BRIGHT|PT_WIND),
    ...
    new quadrenderer("!hint", PT_HAZE|PT_PART),
    new quadrenderer("!hint", PT_HAZE|PT_PART|PT_WIND),
    new taperenderer("<grey>particles/sflare", PT_HAZE|PT_TAPE),
    new trailrenderer("!hint", PT_TRAIL|PT_LERP|PT_WIND),
    &texts, &textontop,
...
void makeparticle(const vec &o, attrvector &attr)
{
    ...
    switch(attr[0])
    {
        ...
        {
            float hintblend = attr[17] > 0 ? attr[17]/100.f : 0.f;
            int hintcolor = attr[16] > 0 ? attr[16] : vec::fromcolor(0x897661).neg().tohexcolor();
        ...
        case 2: // water fountain - <dir>
        {
            ...
            float hintblend = attr[17] > 0 ? attr[17]/100.f : 0.f;
            int hintcolor = attr[16] > 0 ? attr[16] : vec::fromcolor(color).neg().tohexcolor();
        ...
        case 3: // fire ball - <size> <rgb> <type> <blend>
        {
            ...
            float hintblend = attr[17] > 0 ? attr[17]/100.f : 0.f;
            int color = partcolour(attr[2], attr[3], attr[4]), hintcolor = attr[16] > 0 ? attr[16] : vec::fromcolor(color).neg().tohexcolor();
        ...
        case 19: // rain
        {
            ...
            int type = typemap[mapped], fade = attr[4] > 0 ? attr[4] : 250, gravity = !istape ? attr[7] : 0,
                ...
                hintcolor = attr[16] > 0 ? attr[16] : vec::fromcolor(color).neg().tohexcolor();
            float size = attr[5] != 0 ? attr[5]/100.f : sizemap[mapped], vel = !istape ? attr[8] : 1, blend = attr[11] > 0 ? attr[11]/100.f : 1.f, hintblend = attr[17] > 0 ? attr[17]/100.f : 0.f;
        ...
        case 15: // smoke plume
        {
            ...
            float hintblend = attr[17] > 0 ? attr[17]/100.f : 0.f;
            int color = attr[3] ? attr[3] : colormap[attr[0]-14], hintcolor = attr[16] > 0 ? attr[16] : vec::fromcolor(color).neg().tohexcolor();
            regularflame(typemap[attr[0]-14], o, float(attr[1])/100.0f, float(attr[2])/100.0f, color, densitymap[attr[0]-14], attr[4] > 0 ? attr[4] : fademap[attr[0]-14], attr[5] != 0 ? attr[5]/100.f : sizemap[attr[0]-14], attr[10] > 0 ? attr[10]/100.f : 1.f, hintcolor, hintblend, attr[6] != 0 ? attr[6] : gravitymap[attr[0]-14], 0, attr[7] != 0 ? attr[7] : velmap[attr[0]-14]);
            break;
        }
