...
static partrenderer *parts[] =
{
    ...
    new taperenderer("<comp:1>distortflare [tex = particles/sflare]", PT_TAPE|PT_BRIGHT|PT_FEW),
    new taperenderer("<comp:1>distortflare [tex = particles/mflare]", PT_TAPE|PT_BRIGHT|PT_RND4|PT_VFLIP|PT_FEW),
    ...
    new quadrenderer("<comp:1>distortlight [tex = particles/blood]", PT_PART|PT_MOD|PT_RND4|PT_FLIP),
    new quadrenderer("<comp>hintent", PT_PART|PT_BRIGHT),
    new quadrenderer("<comp>hintent", PT_PART|PT_BRIGHT|PT_ONTOP),
    new quadrenderer("<comp:1>distort [tex = particles/spark]", PT_PART|PT_BRIGHT|PT_RND4|PT_FLIP),
    new quadrenderer("<comp:1>fire", PT_SOFT|PT_PART|PT_BRIGHT|PT_HFLIP|PT_RND4|PT_WIND),
    new quadrenderer("<comp:1>fire", PT_PART|PT_BRIGHT|PT_HFLIP|PT_RND4|PT_WIND),
    new quadrenderer("<comp:1>distortlight [tex = particles/plasma]", PT_SOFT|PT_PART|PT_BRIGHT|PT_FLIP|PT_WIND),
    new quadrenderer("<comp:1>distortlight [tex = particles/plasma]", PT_PART|PT_BRIGHT|PT_FLIP|PT_WIND),
    new quadrenderer("<comp:1>distort [tex = particles/electric]", PT_SOFT|PT_PART|PT_BRIGHT|PT_RND4|PT_FLIP|PT_WIND),
    new quadrenderer("<comp:1>distort [tex = particles/electric]", PT_PART|PT_BRIGHT|PT_RND4|PT_FLIP|PT_WIND),
    new quadrenderer("<comp:1>distort [tex = particles/eleczap]", PT_SOFT|PT_PART|PT_BRIGHT|PT_RND4|PT_FLIP|PT_WIND),
    new quadrenderer("<comp:1>distort [tex = particles/eleczap]", PT_PART|PT_BRIGHT|PT_RND4|PT_FLIP|PT_WIND),
    new quadrenderer("<comp:1>fire", PT_PART|PT_BRIGHT|PT_HFLIP|PT_RND4|PT_BRIGHT|PT_WIND),
    new taperenderer("<comp:1>distortflare [tex = particles/sflare]", PT_TAPE|PT_BRIGHT),
    new taperenderer("particles/cleanflare", PT_TAPE|PT_BRIGHT),
    new taperenderer("<comp:1>distortflare [tex = particles/mflare]", PT_TAPE|PT_BRIGHT|PT_RND4|PT_VFLIP|PT_BRIGHT),
    new taperenderer("<comp:1>distortflare [tex = particles/lightning]", PT_TAPE|PT_BRIGHT|PT_HFLIP|PT_VFLIP, 2), // uses same clamp setting as normal lightning to avoid conflict
    new taperenderer("<comp:1>distortflare [tex = particles/lightzap]", PT_TAPE|PT_BRIGHT|PT_HFLIP|PT_VFLIP, 2),
    new quadrenderer("<comp:1>distort [tex = particles/muzzle]", PT_PART|PT_BRIGHT|PT_RND4|PT_FLIP),
    new quadrenderer("<comp:1>distortlight [tex = particles/snow]", PT_PART|PT_BRIGHT|PT_FLIP|PT_WIND),
    new quadrenderer("<comp>hint", PT_HAZE|PT_PART),
    new quadrenderer("<comp:1>fire", PT_HAZE|PT_PART|PT_WIND),
    new taperenderer("<comp:1>distortflare [tex = particles/sflare]", PT_HAZE|PT_TAPE),
