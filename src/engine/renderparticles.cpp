...
{
    new portalrenderer("<comp:1,0.5,2>portal"),
    new portalrenderer("<comp:1,0.5,2>portal", PT_ENVMAP),
    ...
    new quadrenderer("<comp:1,0.5,2>fire", PT_SOFT|PT_PART|PT_BRIGHT|PT_HFLIP|PT_RND4|PT_WIND),
    ...
    new quadrenderer("<comp:1,0.5,2>smoke", PT_SOFT|PT_PART|PT_LERP|PT_FLIP|PT_RND4|PT_WIND),
    new quadrenderer("<comp:1,0.5,2>smoke", PT_PART|PT_LERP|PT_FLIP|PT_RND4|PT_WIND),
    new quadrenderer("<comp:1,0.5,2>smoke", PT_SOFT|PT_PART|PT_FLIP|PT_RND4|PT_WIND),
    new quadrenderer("<comp:1,0.5,2>smoke", PT_PART|PT_FLIP|PT_RND4|PT_WIND),
    ...
    new quadrenderer("<comp:1,0.5,2>fire", PT_SOFT|PT_PART|PT_BRIGHT|PT_HFLIP|PT_RND4|PT_WIND),
    new quadrenderer("<comp:1,0.5,2>fire", PT_PART|PT_BRIGHT|PT_HFLIP|PT_RND4|PT_WIND),
    new quadrenderer("<grey>particles/plasma", PT_SOFT|PT_PART|PT_BRIGHT|PT_FLIP|PT_WIND),
    ...
    new quadrenderer("<comp:1,0.5,2>fire", PT_PART|PT_BRIGHT|PT_HFLIP|PT_RND4|PT_BRIGHT|PT_WIND),
    ...
    new quadrenderer("<comp:1,0.5,2>fire", PT_HAZE|PT_PART|PT_HFLIP|PT_RND4|PT_WIND),
    new taperenderer("<grey>particles/sflare", PT_HAZE|PT_TAPE),
    new trailrenderer("<comp:0,0.25,2>hint", PT_TRAIL|PT_LERP|PT_WIND),
    new quadrenderer("<comp:1,0.5,2>bubble", PT_SOFT|PT_PART|PT_BRIGHT|PT_RND4|PT_FLIP|PT_WIND),
    new quadrenderer("<comp:1,0.5,2>bubble", PT_PART|PT_BRIGHT|PT_RND4|PT_FLIP|PT_WIND),
    ...
    new quadrenderer("<comp:1,0.5,2>bubble", PT_HAZE|PT_PART|PT_RND4|PT_FLIP|PT_WIND),
    new quadrenderer("<comp:1,0.5,2>bubble", PT_SOFT|PT_PART|PT_RND4|PT_FLIP|PT_MATERIAL),
    &texts, &textontop,
