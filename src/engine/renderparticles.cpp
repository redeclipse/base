...
static partrenderer *parts[] =
{
    ...
    new quadrenderer("<comp>fire 1", PT_SOFT|PT_PART|PT_BRIGHT|PT_HFLIP|PT_RND4|PT_WIND),
    ...
    new quadrenderer("<comp>smoke 1", PT_SOFT|PT_PART|PT_LERP|PT_FLIP|PT_RND4|PT_WIND),
    new quadrenderer("<comp>smoke 1", PT_PART|PT_LERP|PT_FLIP|PT_RND4|PT_WIND),
    new quadrenderer("<comp>smoke 1", PT_SOFT|PT_PART|PT_FLIP|PT_RND4|PT_WIND),
    new quadrenderer("<comp>smoke 1", PT_PART|PT_FLIP|PT_RND4|PT_WIND),
    ...
    new quadrenderer("<comp>fire 1", PT_SOFT|PT_PART|PT_BRIGHT|PT_HFLIP|PT_RND4|PT_WIND),
    new quadrenderer("<comp>fire 1", PT_PART|PT_BRIGHT|PT_HFLIP|PT_RND4|PT_WIND),
    new quadrenderer("<grey>particles/plasma", PT_SOFT|PT_PART|PT_BRIGHT|PT_FLIP|PT_WIND),
    ...
    new quadrenderer("<comp>fire 1", PT_PART|PT_BRIGHT|PT_HFLIP|PT_RND4|PT_BRIGHT|PT_WIND),
