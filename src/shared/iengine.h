...
static inline void text_bounds(const char *str, int &width, int &height, float xpad = 0, float ypad = 0, float maxwidth = -1, int flags = 0, float linespace = 0)
{
...
static inline void text_pos(const char *str, int cursor, int &cx, int &cy, float maxwidth, int flags = 0, float linespace = 0)
{
    float cxf, cyf;
