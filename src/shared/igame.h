...
namespace physics
{
    ...
    extern bool checkcollide(physent *d, const vec &dir, physent *o, float guard = 0);
    extern bool checktracecollide(physent *d, const vec &from, const vec &to, float &dist, physent *o, float guard = 0);
}
