...
semabuild_build() {
    ...
    sudo ${SEMABUILD_APT} -o Dpkg::Options::="--force-overwrite" -fy install build-essential:i386 zlib1g-dev:i386 libsdl1.2-dev:i386 libsdl-mixer1.2-dev:i386 libsdl-image1.2-dev:i386 libpng12-dev:i386 libglu1-mesa-dev:i386 libgl1-mesa-dev:i386 || return 1
