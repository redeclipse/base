...
semabuild_build() {
    ...
    sudo ${SEMABUILD_APT} -fy install zlib1g-dev:i386 libsdl1.2-dev:i386 libsdl-mixer1.2-dev:i386 libsdl-image1.2-dev:i386 libpng12-dev:i386 libglu-dev:i386 libgl-dev:i386 || return 1
