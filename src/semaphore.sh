...
semabuild_build() {
    ...
    sudo apt-get -o Dpkg::Options::="--force-overwrite" -fy install build-essential:i386 gcc:i386 g++:i386 cpp:i386 g++-4.8:i386 gcc-4.8:i386 || sudo apt-get -o Dpkg::Options::="--force-overwrite" -fy install || return 1
