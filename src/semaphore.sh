...
semabuild_build() {
    ...
    sudo ${SEMABUILD_APT} -y upgrade || return 1
    sudo ${SEMABUILD_APT} -y autoclean || return 1
    sudo ${SEMABUILD_APT} -y clean || return 1
    sudo ${SEMABUILD_APT} -y autoremove || return 1
    sudo ${SEMABUILD_APT} -fy install build-essential multiarch-support zlib1g-dev libsdl-mixer1.2-dev libsdl-image1.2-dev || return 1 # binutils-mingw-w64 g++-mingw-w64 || return 1
    ...
    sudo ${SEMABUILD_APT} -o Dpkg::Options::="--force-overwrite" -fy install build-essential:i386 g++:i386 g++-multilib:i386 gcc:i386 gcc-multilib:i386 zlib1g-dev:i386 libsdl1.2-dev:i386 libsdl-mixer1.2-dev:i386 libsdl-image1.2-dev:i386 libpng12-dev:i386 libglu1-mesa-dev:i386 libgl1-mesa-dev:i386 || return 1
