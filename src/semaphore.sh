...
semabuild_build() {
    ...
    sudo ${SEMABUILD_APT} -fy install build-essential multiarch-support g++-multilib gcc-multilib zlib1g-dev:i386 libsdl1.2-dev:i386 libsdl-mixer1.2-dev:i386 libsdl-image1.2-dev:i386 libpng12-dev:i386 || return 1
