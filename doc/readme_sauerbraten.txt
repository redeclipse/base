...
not cover new code provided as part of the Tesseract engine or Red Eclipse. For the 
license governing those changes, please see the included "license.txt" and
"readme_tesseract.txt".
...
Copyright (C) 2001-2017 Wouter van Oortmerssen, Lee Salzman,
